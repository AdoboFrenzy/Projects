...
var Clock = function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      var hours = (this.state.date.getHours() % 12).toString();
      var minutes = this.state.date.getMinutes().toString();
      var seconds = this.state.date.getSeconds().toString();
      var am = " AM";
      var pm = " PM";
      var checkAmPm = this.state.date.getHours() >= 12 ? pm : am;
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    key: "selectTab",
    value: function selectTab(newTab) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("header", { className: "currentTab" }),
          _react2.default.createElement(
            "article",
            { className: "currentContent" },
            _react2.default.createElement("img", { src: "./styles/images/Horgi.jpg" })
          )
        )
      );
    }
...
var Weather = function (_React$Component) {
  ...
  _createClass(Weather, [{
    ...
    key: "getinfo",
    value: function getinfo(position) {
      var _this2 = this;
      ...
      var myAPI = "bb5690b06d5f6cba115d6b77ce6198ee";

      var url = this.state.url + ("lat=" + lati + "&lon=" + long + "&APPID=") + myAPI;
...
var _congrats = __webpack_require__(/*! ./congrats */ "./frontend/congrats.jsx");
